...
// Handler maneja las peticiones HTTP para eliminar categorías
type Handler struct {
...
// Handle procesa la petición para eliminar una categoría
func (h *Handler) Handle(c *gin.Context) {
	...
	err := h.service.Delete(categories.DeleteCategoryRequest{
		ID:     id,
		UserID: userID,
	})
	if err != nil {
	...
	httpUtil.SendSuccess(c, http.StatusOK, nil, "Category deleted successfully")
}

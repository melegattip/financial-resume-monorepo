                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {expense.amount_paid > 0 && !expense.paid && (
                      <div className="flex items-center gap-1 mt-0.5">
                        <span className="px-1.5 py-0.5 rounded text-xs font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 border border-yellow-400">
                          Parcial: {formatAmount(expense.amount_paid)} / {formatAmount(expense.amount)}
                        </span>
                      </div>
                    )}
                  </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-fr-lg max-w-md w-full p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-fr-gray-700 dark:text-gray-300 mb-2">
                  Fecha de transacción
                  <span className="text-xs text-gray-500 ml-2">(Cuándo ocurrió el gasto)</span>
                </label>
                <input
                  type="date"
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Puede ser una fecha pasada, presente o futura
                </p>
              </div>

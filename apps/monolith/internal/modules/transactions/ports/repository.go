...
type ExpenseRepository interface {
	...
	FindByTenantID(ctx context.Context, tenantID string, limit, offset int) ([]*domain.Expense, error)
...
type IncomeRepository interface {
	...
	FindByTenantID(ctx context.Context, tenantID string, limit, offset int) ([]*domain.Income, error)
...
type CategoryRepository interface {
	...
	FindByTenantID(ctx context.Context, tenantID string) ([]*domain.Category, error)
